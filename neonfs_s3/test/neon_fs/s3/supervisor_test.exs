defmodule NeonFS.S3.SupervisorTest do
  use ExUnit.Case, async: false

  alias NeonFS.S3.Supervisor

  describe "listener_child_spec/0" do
    test "wires the default drain deadline into the Bandit listener" do
      Application.delete_env(:neonfs_s3, :drain_deadline_ms)
    ...
    test "respects a configured drain deadline" do
      Application.put_env(:neonfs_s3, :drain_deadline_ms, 12_000)
      on_exit(fn -> Application.delete_env(:neonfs_s3, :drain_deadline_ms) end)
