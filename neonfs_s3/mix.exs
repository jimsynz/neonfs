defmodule NeonFS.S3.MixProject do
  ...
  defp deps do
    [
      ...
      # `:neonfs_webdav` is needed by `peer_cluster_mixed_role_test.exs`,
      # which spawns a `:neonfs_webdav` interface peer alongside the S3
      # one to prove the harness starts interface-only peers of more than
      # one type.
