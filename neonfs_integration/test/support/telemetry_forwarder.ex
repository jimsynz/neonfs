defmodule NeonFS.Integration.TelemetryForwarder do
  ...
  `NeonFS.TestSupport.TelemetryForwarder` (sub-issue #599 of #582).
  ...
  for {fun, arity} <- TelemetryForwarder.__info__(:functions) do
    args = Macro.generate_arguments(arity, __MODULE__)

    def unquote(fun)(unquote_splicing(args)) do
      apply(TelemetryForwarder, unquote(fun), [unquote_splicing(args)])
    end
  end
end
