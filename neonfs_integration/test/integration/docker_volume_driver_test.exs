defmodule NeonFS.Integration.DockerVolumeDriverTest do
  ...
  setup %{cluster: cluster} do
    ...
    socket_path =
      Path.join(
        System.tmp_dir!(),
        "neonfs_docker_test_#{System.unique_integer([:positive])}.sock"
      )
  ...
  describe "real docker daemon" do
    test "create volume → run container that writes + reads → remove volume" do
    ...
    test "Plugin.Activate handshake is reachable through the daemon" do
