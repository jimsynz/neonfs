...
for component in neonfs_core neonfs_fuse neonfs_nfs neonfs_s3 neonfs_docker neonfs_omnibus; do
...
for config in neonfs-cli neonfs-common neonfs-core neonfs-fuse neonfs-nfs neonfs-s3 neonfs-docker neonfs-omnibus; do
    echo "    ${config}..."
